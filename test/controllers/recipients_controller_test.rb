...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { email: @recipient.email, first_name: @recipient.first_name, last_name: @recipient.last_name, snail_mail: @recipient.snail_mail }
    end
  ...
  test "should update recipient" do
    patch :update, id: @recipient, recipient: { email: @recipient.email, first_name: @recipient.first_name, last_name: @recipient.last_name, snail_mail: @recipient.snail_mail }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
